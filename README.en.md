...
[简体中文](README.md) · [Download](https://github.com/study-233/ailimits/releases/latest) · [Configuration](docs/en/CONFIG.md) · [Changelog](CHANGELOG.md)
...
The v0.4.0 build uses QuotaBar asset names. Public availability follows the releases actually published. This distribution is not published to winget, Scoop, Chocolatey or Microsoft Store.
...
**Why did the installed name contain “fork”?** The old installer embedded that name. v0.4.0 uses the independent QuotaBar name; an in-place installation updates the displayed name.
